...
Codes prepended with "*" indicate there is a build_x_dataset.py that is specifically used to generate the dataset for summary type x. Use this instead of inout_to_csv.py.
